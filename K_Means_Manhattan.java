...
public class K_Means_Manhattan {
	...
	/*---------------------------------------------------------
	*class Vector
	*		A vector, and the distance with the centroid for Manhattan distance.
	---------------------------------------------------------*/
	...
	/*----------------------------------------
	*class ManhattanMapper
	*		Read data to parse a vector, and calculate Manhattan distance 
	...
	*		Run the chain for loop job and output the new centroid and cost function.
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 0 ; i < 20 ; i++){
			...
			Job job1 = new Job(conf, ("Manhattan" + String.valueOf(i)));
			job1.setJarByClass(K_Means_Manhattan.class);
			
			job1.setMapperClass(ManhattanMapper.class);
			job1.setReducerClass(ManhattanReducer.class);
